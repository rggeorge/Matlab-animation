function eyehandle = rev_eyepatch(name, radius, nsegs, iriscolour)

% function eyehandle = eyepatch(name, radius, nsegs, iriscolour)
...
%Changed by Ryan George: Line 74
%change: added ' rigidbody(eyehandle, name); '
