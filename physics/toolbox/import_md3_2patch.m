function varargout = import_md3_2patch(filename)

% function handles = import_md3_2patch(filename)
% Imports md3 files into matlab as patch objects
% md3 files can be exported from gmax
% 
...
for i=1:numMeshes
    ...
    % name from tag
    name = mesh(i).meshName; 
   
    % create patch object
    h = patch('vertices', vertices, 'faces', faces, 'facecolor', [.3 .3 .3], 'tag', name);
